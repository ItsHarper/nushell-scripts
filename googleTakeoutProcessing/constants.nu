export const takeoutStateFilePath = "/run/media/harper/X400/MOEGoogleAccountTakeout/takeoutState.nuon"
...
export const SAFE_PROGRESS_VALUES_FOR_EXTRACTION = [ $PROGRESS_NONE, $PROGRESS_DOWNLOADED ]
